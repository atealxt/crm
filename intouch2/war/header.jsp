...
<div id="header" style="display:none;">
	...
	<ul class="nav">
		<!-- <li id="navhome"><a href="javascript:layoutHome();"><span><img alt="" src="images/top-home.png"/></span><i18n:message key="home"/></a></li> -->
		<li class="active" id="navmail"><a href="javascript:layoutMail();"><span><img alt="" src="images/top-mail.png"/></span><i18n:message key="mail"/></a></li>
...
<!--	<li id="navwebdisk"><a href="javascript:layoutWebdisk();"><span><img alt="" src="images/top-disk.png"/></span><i18n:message key="web.disk"/></a></li> -->
		...
		<li id="navnotes"><a target="_blank" href="<c:url value="/admin"/>"><span><img alt="" src="images/top-chat.png"/></span><spring:message code="Administrator.management" text="Administrator.management"/></a></li>
	</ul>
</div>
