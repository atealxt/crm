...
<body scroll="no" oncontextmenu="return false" onselectstart="return selectstart(event)" 
	onunload="unloadHandler()" onmousemove="getPos(event)" onload="onloadHandler(event)" 
...
<iframe src="#" width="100" height="100" style="display: none;" id="downloader"></iframe>
<div id="uploader"></div>
</body>
</html>
